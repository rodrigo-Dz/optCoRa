...
opt  = (pOp  = [:mU, :mW, :eP],	        # Parameters to optimize
        ...
        mean = NaN,                     # mean for the acceptance probability function (log scale)
        sd = 0.5                        # standard deviation for the acceptance probability function (log scale
        )	

# Dynamics details
dyn = (tspan = (0.0, 5000.0),   # time span for the simulation
