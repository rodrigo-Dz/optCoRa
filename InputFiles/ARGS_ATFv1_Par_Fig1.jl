...
p = Dict([
    ...
    :mU  => 2.06,     # U synthesis rate dependent of Y (nM/min)
    :gU  => 0.0001,    # U degradation rate (e.g. [0.0301,0.0408] 1/min, with degODC)
    :mW  => 60.2,       #0.1 # W constitutive synthesis rate (e.g. [0.005,0.02] nM/min)
    ...
    :eP  => 62.3,    # U:W association (binding) rate (e.g. [0.0012,2000] 1/nM 1/min)
