...
p = Dict([
    ...
    :mU  => 6.27,     # U synthesis rate dependent of Y (nM/min)
    :gU  => 0.0001,    # U degradation rate (e.g. [0.0301,0.0408] 1/min, with degODC)
    :mW  => 0.707,       # W constitutive synthesis rate (e.g. [0.005,0.02] nM/min)
    ...
    :eP  => 75.5,    # U:W association (binding) rate (e.g. [0.0012,2000] 1/nM 1/min)
