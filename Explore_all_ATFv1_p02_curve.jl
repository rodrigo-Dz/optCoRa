...
p = OrderedDict(
    ...
    :mU  => 5.45,     # U synthesis rate dependent of Y (nM/min)
    :gU  => 0.0001,    # U degradation rate (e.g. [0.0301,0.0408] 1/min, with degODC)
    :mW  => 0.401,       # W constitutive synthesis rate (e.g. [0.005,0.02] nM/min)
    ...
    :eP  => 6.590,    # U:W association (binding) rate (e.g. [0.0012,2000] 1/nM 1/min)
    :eM  => 0.5,       # U:W (C) mutual anhilation/co-degradation (e.g. [0.03,2] 1/nM 1/min)
    :m0  => 75.05,      # Y0 synthesis rate dependent of W (nM/min)
