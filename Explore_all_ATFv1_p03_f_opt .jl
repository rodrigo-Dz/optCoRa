...
=#
    ...
    writedlm("optimization_ATFv1_p03_f.csv", results_matrix, ',')
...
iter = 1000.0				# Number of iterations per optimization run
...
plot(r[:,4], label="mU", lw=2)
plot!(r[:,6], label="mW", lw=2)
plot!(r[:,9], label="eP", lw=2)
yaxis!(:log10)
xlabel!("Iteración")
ylabel!("Valor del parámetro")
title!("Evolución de parámetros en optimización")
