...
params = [
    ...
    0.00265,    #4 mU   U synthesis rate dependent of Y (nM/min)
    0.0001,  #5 gU   U degradation rate (e.g. [0.0301,0.0408] 1/min, with degODC)
    748.2,     #6 mW   W constitutive synthesis rate (e.g. [0.005,0.02] nM/min)
    ...
    430.31,   #9 eP   U:W association (binding) rate (e.g. [0.0012,2000] 1/nM 1/min)
