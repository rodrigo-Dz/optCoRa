...
for mY in mY_range, mU in mU_range
    ...
    push!(bifurcation_data, (mY, mU, max_real_positive, max_imaginary))
end
...
max_imaginary_values = [data[4] for data in bifurcation_data]
...
heatmap(mY_range, mU_range, max_real_positive_grid, xlabel="mY", ylabel="mW",
        title="Parte Real Positiva de Eigenvalues", xscale=:log10, yscale=:log10,
