...
contribution_Y_slow_grid = reshape(contribution_Y_slow_values, (length(mY_range), length(mU_range)))
contribution_Y_fast_grid = reshape(contribution_Y_fast_values, (length(mY_range), length(mU_range)))
contribution_U_slow_grid = reshape(contribution_U_slow_values, (length(mY_range), length(mU_range)))
contribution_U_fast_grid = reshape(contribution_U_fast_values, (length(mY_range), length(mU_range)))
contribution_W_slow_grid = reshape(contribution_W_slow_values, (length(mY_range), length(mU_range)))
contribution_W_fast_grid = reshape(contribution_W_fast_values, (length(mY_range), length(mU_range)))
contribution_C_slow_grid = reshape(contribution_C_slow_values, (length(mY_range), length(mU_range)))
contribution_C_fast_grid = reshape(contribution_C_fast_values, (length(mY_range), length(mU_range)))
...
savefig("./bifurcation_ATF/Lambda_lento_abs.png")
...
savefig("./bifurcation_ATF/Lambda_lento_sign.png")
...
savefig("./bifurcation_ATF/Lambda_fast.png")
...
savefig("./bifurcation_ATF/Lambda_fast_sign.png")
...
savefig("./bifurcation_ATF/Lambda_im.png")
...
savefig("./bifurcation_ATF/Contribution_Y_slow.png")
...
savefig("./bifurcation_ATF/Contribution_Y_fast.png")
...
savefig("./bifurcation_ATF/Contribution_U_slow.png")
...
savefig("./bifurcation_ATF/Contribution_U_fast.png")
...
savefig("./bifurcation_ATF/Contribution_W_slow.png")
...
savefig("./bifurcation_ATF/Contribution_W_fast.png")
...
savefig("./bifurcation_ATF/Contribution_C_slow.png")
...
savefig("./bifurcation_ATF/Contribution_C_fast.png")
